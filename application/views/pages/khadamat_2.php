...
if (isset($_REQUEST['parvaz_mosafer_id'])) {
    ...
    if ($this->form_validation->run() == FALSE) {
        ...
        foreach ($mosafer_id as $i => $mosafer_id0) {
            $tarikh_tavalod = '0000-00-00 00:00:00';
            if ($_REQUEST['parvaz_tarikh_tavalod-sal'][$i] != 0 && $_REQUEST['parvaz_tarikh_tavalod-mah'][$i] != 0 && $_REQUEST['parvaz_tarikh_tavalod-rooz'][$i] != 0) {
...
if (isset($_REQUEST['tour_mosafer_id'])) {
    ...
    $ticket_number = isset($_REQUEST['tour_ticket_number']) ? $_REQUEST['tour_ticket_number'] : '';
    if ($this->form_validation->run() == FALSE) {
        $valid = FALSE;
    } else {
        foreach ($mosafer_id as $i => $mosafer_id0) {
            $tarikh_tavalod = '0000-00-00 00:00:00';
            if ($_REQUEST['tour_tarikh_tavalod-sal'][$i] != 0 && $_REQUEST['tour_tarikh_tavalod-mah'][$i] != 0 && $_REQUEST['tour_tarikh_tavalod-rooz'][$i] != 0) {
