...
class Profile_model extends CI_Model {
    ...
    public function add($data) {
        $out = -1;
        $my = new mysql_class;
        if ((int) $data['sal'] != 0 && (int) $data['mah'] != 0 && (int) $data['rooz'] != 0) {
