<?php
    ...
    $input =array($gname1=>array('table'=>'khadamat_det','div'=>'div_country'));
    $xgrid1 = new xgrid($input,site_url().'khadamat_det?');
    $xgrid1->pageRows[$gname1]=10;
    $xgrid1->column[$gname1][0]['name']= '';
    $xgrid1->column[$gname1][1]['name'] = 'نام';
    $xgrid1->column[$gname1][2]['name'] = 'نوع';
    $xgrid1->column[$gname1][2]['clist'] =  array(
            0 => '',
            1=>'پرواز',
            2=>'هتل',
            3=>'تور',
